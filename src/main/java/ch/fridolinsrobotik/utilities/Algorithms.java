...
public class Algorithms {
     ...
     * @return scaled vector
     */
    public static Translation2d scale(Translation2d v, double inMin, double inMax, double outMin, double outMax) {
        double factor = Algorithms.scale(v.getNorm(), inMin, inMax, outMin, outMax) / v.getNorm();
        return new Translation2d(v.getX() * factor, v.getY() * factor);
    }
