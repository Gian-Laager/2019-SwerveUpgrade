...
public class Robot extends TimedRobot {
    ...
    public void teleopPeriodic() {
        ...
        // DriverStation.reportWarning(Double.valueOf(Timer.getFPGATimestamp() -
        // t1).toString(), false);
        double joystickX = OI.JoystickMainDriver.getX();
        double joystickY = OI.JoystickMainDriver.getY();
        double joystickZ = OI.JoystickMainDriver.getZ();
        ...
        double joystickZrotateSupport = Deadzone.getAxis(-OI.JoystickSupportDriver.getRawAxis(3),
                RobotMap.DEADZONE_RANGE);
        ...
        if (RobotMap.ROBOT_ELEVATOR_SUBSYSTEM_IN_USE && RobotMap.LIFTING_UNIT_SUBSYSTEM_IS_IN_USE) {
            ...
            SmartDashboard.putNumber(" Elevator dif: ",
                    (Motors.robotElevatorRight.getSelectedSensorPosition(0)
                            - Motors.robotElevatorLeft.getSelectedSensorPosition(0))
                            / elevator.getLiftingUnitElevatorRatio() / 2000.0);
            ...
            if (OI.JoystickSupportDriver.getPOV(RobotMap.SUPPORT_POV_CHANNEL_ID) == 270) {
                ...
                SmartDashboard.putNumber("ELR Output",
                        elevator.getElevatorRightOutput() / elevator.getNormalizeFactor());
                SmartDashboard.putNumber("ELL Output",
                        elevator.getElevatorLeftOutput() / elevator.getNormalizeFactor());
